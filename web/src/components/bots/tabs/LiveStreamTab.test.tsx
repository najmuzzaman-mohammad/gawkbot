/**
 * Regression: LiveStreamTab and BotProfilePanel (Config tab) share the
 * React Query key ["bot-log-tasks", slug]. BotProfilePanel caches an
...
describe("LiveStreamTab recent-runs cache shape", () => {
  ...
  it("caches an array under the shared ['bot-log-tasks', slug] key", async () => {
