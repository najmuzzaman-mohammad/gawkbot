...
func TestBotPhaseConstants(t *testing.T) {
	phases := []BotPhase{PhaseIdle, PhaseBuildContext, PhaseStreamLLM, PhaseExecuteTool, PhaseDone, PhaseError}
...
func TestBotToolExecute(t *testing.T) {
	tool := BotTool{
		Name:        "test_tool",
