...
These fixtures model the first WUPHF workflows where bot output should be HTML first:
...
`STYLE.md` defines the WUPHF paper-manual artifact style bots should use by
