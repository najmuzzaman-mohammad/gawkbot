...
6. Fold in the highest-leverage deltas from `nex-crm/business-musings` bot comparison — citation-style memory UX, Sandcastle-style run records, Claude-Squad-style coding lanes, OpenHands-style credibility/evals — without expanding into a new product.
